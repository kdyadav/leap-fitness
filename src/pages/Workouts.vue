<template>
    <div class="p-6 max-w-3xl mx-auto" style="background-color: var(--bg-primary);">
        ...
        <!-- Programs Section -->
        <div class="mb-8">
            <h2 class="text-2xl font-bold mb-4" style="color: var(--text-primary);">Workout Plans</h2>
        ...
        <!-- Workouts Section -->
        <div>
            <h2 class="text-2xl font-bold mb-4" style="color: var(--text-primary);">Individual Workouts</h2>
            <div class="flex flex-col gap-4">
...
import { IconChevronRight, IconClock, IconCalendar } from '@tabler/icons-vue';
import { useWorkoutStore, useProgramStore } from '../stores/index.js';
